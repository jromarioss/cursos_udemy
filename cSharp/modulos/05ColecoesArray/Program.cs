...
namespace _05ColecoesArray
{
    internal class Program
    {
        static void Main(string[] args)
        {
            #region Array unidimencional
            //// criação de um vetor de números inteiros de 5 posição
            //int[] numero = new int[5];
            //numero[0] = 10; // o indicie 0 recebe 10
            //numero[1] = 11; // o indicie 0 recebe 11
            //numero[2] = 12; // o indicie 0 recebe 12
            //numero[3] = 13; // o indicie 0 recebe 13
            //numero[4] = 14; // o indicie 0 recebe 14
