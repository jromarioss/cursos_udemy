...
public class ProdutosController : ControllerBase
{
    ...
    [HttpGet]
    public ActionResult<IEnumerable<ProdutoDTO>> Get([FromQuery] ProdutosParameters produtosParameters) // o actionresult permite ter varios tipo de reposta como notfound ok...
    {
        try
        {
